//! Simple DCUtR Connection Test
//!
//! This test verifies basic DCUtR connection establishment and data transfer.
...
#[tokio::test]
async fn test_simple_dcutr_connection() {
    // Initialize logging
    ...
    info!("🧪 Starting simple DCUtR connection test...");
    ...
    // Build swarm for peer 1 with longer keepalive
    ...
    // Build swarm for peer 2 with longer keepalive
    ...
    let response_received = timeout(Duration::from_secs(30), async {
    ...
    info!("✅ Simple DCUtR connection test completed successfully!");
}
